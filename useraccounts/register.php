    ...
    <div >
        <h1>Registeration</h1>
            <form action="register.php" method="post">
                ...
                <hr>
                <button type="submit" class="btn btn-primary" id="register" name="create" value="sign up">Sign in</button>
            </form>
    </div>
        <!--Bootstrap-->
                ...
                $('#register').click(function(e) {
                    ...
                    if(valid){
                        ...
                        $.ajax({
                            type:'POST',
                            url:'process.php',
                            data:{email: email , firstname: firstname , lastname: lastname , phonenumber: phonenumber , password: password , address: address ,address2: address2 , city: city , zipcode: zipcode, age:age},
